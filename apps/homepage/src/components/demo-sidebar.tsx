...
export const SidebarContent = ({
  ...
  return (
    <>
      ...
      {/* Sidebar Panel */}
      <div
        className={`fixed inset-y-0 left-0 w-64 bg-bg-sidebar border-r border-border-primary flex-col shrink-0 z-30 transition-all duration-300 md:static md:translate-x-0 ${
          isOpen ? 'flex translate-x-0' : 'hidden md:flex -translate-x-full'
        }`}
      >
        {/* Sidebar Content */}
        <div className="flex-1 overflow-y-auto py-4 px-2 space-y-4">
          ...
          <div className="border-t border-border-primary/80 pt-3 px-1 space-y-2.5">
            ...
            <div className="flex items-center justify-between pt-1">
              ...
              >
                <span
                  className="absolute top-px left-[2px].5 w-4 h-4 rounded-full bg-white shadow-md transition-transform duration-200"
                  style={{
