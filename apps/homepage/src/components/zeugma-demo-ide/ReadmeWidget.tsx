export function ReadmeWidget() {
  return (
    <div className="h-full w-full bg-[#1e1e1e] overflow-auto p-8 text-zinc-300 select-text font-sans max-w-3xl mx-auto">
      ...
      <ul className="space-y-4 list-none pl-0">
        <li className="flex items-start gap-3">
          <span className="text-indigo-400 font-extrabold text-lg select-none leading-none">✦</span>
          <div>
        ...
        <li className="flex items-start gap-3">
          <span className="text-violet-400 font-extrabold text-lg select-none leading-none">✦</span>
          <div>
